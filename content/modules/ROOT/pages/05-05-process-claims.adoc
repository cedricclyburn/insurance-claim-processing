...
* Start by downloading the `https://raw.githubusercontent.com/rh-aiservices-bu/insurance-claim-processing/main/lab-materials/05/05-05/process_claims.yaml[process_claims.yaml]` file locally to your laptop
